    ...
    <section class="content overflow-x-scroll rounded-lg overflow-y-scroll h-full mx-auto py-5 px-5 min-h-screen">
        ...
        <div class="mb-3">
            <div class="mb-5 flex flex-grow flex-col md:flex-row items-center justify-center md:justify-between">
                <h4 class="heading mb-3 md:mb-0">Slider Menu</h4>

                <div>
                    <a href="{{route('slidermenu.form')}}">
           ...
           <div>
               ...
               @livewire("slider-menu.slider-menu-table")
           </div>
...
@push("scripts")
    ...
    @include("includes._dt-scripts",['table' => 'slider-menu.slider-menu-table'])
@endpush
